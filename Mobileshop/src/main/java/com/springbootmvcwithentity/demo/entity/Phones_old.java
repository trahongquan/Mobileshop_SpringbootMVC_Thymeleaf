...
//    }
//
//    public Phone(int brandId, int categoryId, String phoneName, int modelID, int releaseYear, double screenSize, int storageCapacityID, int ramID, int operatingSystemID, String price, int colorID, String imageName, int quantity, String seri) {
